...
# Extra message sent right after the file + the "will be deleted in 10 mins" notice.
# Leave empty ('') to send nothing. Paste your own text/HTML here to customize it.
CUSTOM_MSG = environ.get("CUSTOM_MSG", "")
